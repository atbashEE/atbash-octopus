...
public class NamedDomainPermissionTest {
    ...
    @Test
    public void creation_WithWildCard() {
        namedDomainPermission = new NamedDomainPermission("test", DOMAIN + ":" + ACTION1 + ", " + ACTION2 + ":" + "*");
    ...
    @Test
    public void getWildcardNotation() {
        namedDomainPermission = new NamedDomainPermission("test", DOMAIN, ACTION1 + ", " + ACTION2, "*");
        assertThat(namedDomainPermission.getWildcardNotation()).isEqualTo(DOMAIN + ":" + ACTION1.toLowerCase() + "," + ACTION2.toLowerCase() + ":*");

    }

    @Test
    public void getWildcardNotation_WithWildCard() {
        namedDomainPermission = new NamedDomainPermission("test", DOMAIN + ":" + ACTION1 + ", " + ACTION2 + ":" + "*");
        String expected = DOMAIN + ":" + ACTION1.toLowerCase() + "," + ACTION2.toLowerCase() + ":*";
