 ...
 * {@link be.atbash.ee.security.octopus.authz.permission.PermissionResolver PermissionResolver}</li>
 ...
 * {@link be.atbash.ee.security.octopus.authc.AuthenticationInfo AuthenticationInfo} interface for use during the authentication
 * process that represents identity data such as principals and credentials.
 * <p/>
 *
 * @see be.atbash.ee.security.octopus.authc.AuthenticationInfo AuthenticationInfo
 */
@ShiroEquivalent(shiroClassNames = {"org.apache.shiro.authz.AuthorizationInfo"})
public interface AuthorizationInfo extends Serializable {
     ...
     * {@link be.atbash.ee.security.octopus.authz.permission.PermissionResolver PermissionResolver}
