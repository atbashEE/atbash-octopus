...
public class OctopusUserRequestorTest {
    ...
    public void getOctopusSSOToken() throws ParseException, JOSEException, OctopusRetrievalException, com.nimbusds.oauth2.sdk.ParseException, URISyntaxException {
        ...
        when(octopusServerConfigurationMock.getUserInfoEndpoint()).thenReturn("http://localhost:" + Jadler.port() + "/oidc/octopus/sso/user");
        when(octopusServerConfigurationMock.getOctopusSSOServer()).thenReturn("http://localhost/oidc");
        when(octopusServerConfigurationMock.getSSOClientId()).thenReturn("JUnit_client");
        when(octopusServerConfigurationMock.getSSOIdTokenSecret()).thenReturn(secret.getBytes());
    ...
    public void getOctopusSSOToken_missingAud() throws ParseException, JOSEException, OctopusRetrievalException, com.nimbusds.oauth2.sdk.ParseException, URISyntaxException {
        ...
        when(octopusServerConfigurationMock.getUserInfoEndpoint()).thenReturn("http://localhost:" + Jadler.port() + "/oidc/octopus/sso/user");
        when(octopusServerConfigurationMock.getOctopusSSOServer()).thenReturn("http://localhost/oidc");
        when(octopusServerConfigurationMock.getSSOClientId()).thenReturn("anotherClient");
        when(octopusServerConfigurationMock.getSSOIdTokenSecret()).thenReturn(secret.getBytes());
