...
public class OTPConfiguration extends AbstractConfiguration implements ModuleConfig {
    ...
    public String getOTPProvider() {
        return getOptionalValue("otp.provider", "DOTP", String.class);
    }

    @ConfigEntry
    public String getOTPConfigFile() {
        return getOptionalValue("otp.configFile", String.class);
    }

    @ConfigEntry
    public int getOTPLength() {
        return getOptionalValue("otp.length", 6, Integer.class);
    }
}
