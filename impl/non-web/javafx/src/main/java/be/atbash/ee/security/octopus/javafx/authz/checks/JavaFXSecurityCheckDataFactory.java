...
/**
 * Converts Permission information classes (like RequiresPermissions) to  SecurityCheckData instance.
 * It converts info places within FXML view into structure used by Octopus Core to verify authz.
 */
public class JavaFXSecurityCheckDataFactory {
    ...
    public static SecurityCheckData defineSecurityCheckData(RequiresPermissions requiresPermissions) {
        ...
        SecurityCheckData.SecurityCheckDataBuilder builder = new SecurityCheckData.SecurityCheckDataBuilder(SecurityCheckType.REQUIRES_PERMISSIONS);
        builder.withValues(new String[]{requiresPermissions.getValue()});
