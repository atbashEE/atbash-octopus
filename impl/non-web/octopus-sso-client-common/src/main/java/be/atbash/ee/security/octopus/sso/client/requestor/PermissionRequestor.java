...
public class PermissionRequestor extends AbstractRequestor {
    ...
    public PermissionRequestor(OctopusCoreConfiguration coreConfiguration, OctopusSSOServerClientConfiguration configuration, ClientCustomization clientCustomization, Configuration clientConfiguration, PermissionJSONProvider permissionJSONProvider) {
