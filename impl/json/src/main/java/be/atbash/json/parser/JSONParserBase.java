...
abstract class JSONParserBase {
     ...
     * generated by a ContainerFactory
     */
    protected <T> T readFirst(JsonReaderI<T> mapper) throws IOException {
        for (; ; ) {
            switch (c) {
                // skip spaces
                case ' ':
     ...
     * generated by a ContainerFactory
     */
    protected Object readMain(JsonReaderI<?> mapper, boolean stop[]) throws IOException {
        for (; ; ) {
            switch (c) {
                // skip spaces
                case ' ':
    ...
    protected <T> T readObject(JsonReaderI<T> mapper) throws IOException {
        //
        if (c != '{') {
            throw new RuntimeException("Internal Error");
        }
