...
public class GithubServletTest {
    ...
    @Mock
    private GithubOAuth2ServiceProducer githubOAuth2ServiceProducerMock;
    ...
    @InjectMocks
    private GithubServlet githubServlet;
    ...
    public void doGet() throws IOException, ServletException {
        ...
        when(githubOAuth2ServiceProducerMock.createOAuthService(requestMock, "csrfToken")).thenReturn(oauth20ServiceMock);
        when(oauth20ServiceMock.getAuthorizationUrl()).thenReturn("http://auth.server/root/login");

        githubServlet.doGet(requestMock, responseMock);
