 ...
 */
@ApplicationScoped
@ShiroEquivalent(shiroClassNames = {"org.apache.shiro.web.filter.authc.BasicHttpAuthenticationFilter"})
public class BasicHttpAuthenticationFilter extends AuthenticatingFilter {
    ...
    protected boolean sendChallenge(ServletRequest request, ServletResponse response) {
        ...
        httpResponse.setHeader(WebConstants.AUTHENTICATE_HEADER, authcHeader);
        return false;
    }
