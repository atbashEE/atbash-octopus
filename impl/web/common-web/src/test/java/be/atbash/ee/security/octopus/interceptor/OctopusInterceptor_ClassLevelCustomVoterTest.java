...
public class OctopusInterceptor_ClassLevelCustomVoterTest extends OctopusInterceptorTest {
    ...
    public void testInterceptShiroSecurity_CustomerVoter1(TestInterceptorParameters parameters) throws Exception {
        setup(parameters);
    ...
    @ParameterizedTest
    @MethodSource("provideArguments")
    public void testInterceptShiroSecurity_CustomVoter2(TestInterceptorParameters parameters) throws Exception {
        setup(parameters);
