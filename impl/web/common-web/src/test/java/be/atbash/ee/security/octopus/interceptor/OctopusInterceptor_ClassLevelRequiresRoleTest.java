...
public class OctopusInterceptor_ClassLevelRequiresRoleTest extends OctopusInterceptorTest {
    ...
    private static Stream<Arguments> provideArguments() {
        return Stream.of(
                ...
                Arguments.of(new TestInterceptorParameters(AUTHENTICATED, PERMISSION2, NO_CUSTOM_ACCESS, null, null)),
                ...
                Arguments.of(new TestInterceptorParameters(AUTHENTICATED, null, NO_CUSTOM_ACCESS, null, ROLE2))
        );
    }
    ...
    private void performAndCheck(InvocationContext context, TestInterceptorParameters parameters) throws Exception {
        ...
        try {
            ...
            assertThat(parameters.getRole()).isNotEqualToIgnoringCase(ROLE1);
        }
    }
