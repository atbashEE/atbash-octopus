...
public class GithubOAuth2ServiceProducerTest {
    ...
    @InjectMocks
    private GithubOAuth2ServiceProducer serviceProducer;
    ...
    public void createOAuthService() {
        ...
        assertThat(service.getAuthorizationUrl()).isEqualTo("https://github.com/login/oauth/authorize?response_type=code&client_id=clientId&redirect_uri=http%3A%2F%2Fsome.server%2Foidc%2Foauth2callback&state=CSRF");
    }
    ...
    public void createOAuthService_additionalScopes() {
        ...
        OAuth20Service service = serviceProducer.createOAuthService(httpServletRequestMock, "CSRF");
        assertThat(service.getAuthorizationUrl()).isEqualTo("https://github.com/login/oauth/authorize?response_type=code&client_id=clientId&redirect_uri=http%3A%2F%2Fsome.server%2Foidc%2Foauth2callback&scope=ScopeX&state=CSRF");
    }
    ...
    public void createOAuthService_NoCSRF() {
        ...
        assertThat(service.getAuthorizationUrl()).isEqualTo("https://github.com/login/oauth/authorize?response_type=code&client_id=clientId&redirect_uri=http%3A%2F%2Fsome.server%2Foidc%2Foauth2callback");
    }
