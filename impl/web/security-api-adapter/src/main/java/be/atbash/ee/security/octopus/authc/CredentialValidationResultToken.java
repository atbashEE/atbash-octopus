...
public class CredentialValidationResultToken implements ValidatedAuthenticationToken {

    private CredentialValidationResult credentialValidationResult;

    public CredentialValidationResultToken(CredentialValidationResult credentialValidationResult) {
        this.credentialValidationResult = credentialValidationResult;
    }

    @Override
    public Object getPrincipal() {
        return credentialValidationResult.getCallerPrincipal();
    }
