 ...
 */
@ApplicationScoped
public class OAuth2ProviderControl {

    private List<OAuth2Provider> providerInfos;

    @PostConstruct
    public void init() {
        providerInfos = CDIUtils.retrieveInstances(OAuth2Provider.class);
    }

    public List<OAuth2Provider> getProviderInfos() {
        return providerInfos;
    }

    public OAuth2Provider getProviderMetaData(String provider) {
        OAuth2Provider result = null;
    ...
    public OAuth2Provider getSingleProviderMetaData() {
