...
/**
 * Base abstract Filter simplifying Filter creation by providing empty implementations of {@link #init(FilterConfig) init}
...
public abstract class AbstractFilter implements Filter {
    ...
    /**
     * Default no-op implementation that can be overridden by subclasses for custom init behavior.
     * But be aware that most filters are 'Octopus' Filters and thus CDI based and not really instantiated by the
     * system. And thus init should be achieved by a @PostConstruct method.
     */
    @Override
     ...
     * But be aware that most filters are 'Octopus' Filters and thus CDI based and not really instantiated by the
     * system. And thus init should be achieved by a @PreDestroy method.
     */
    @Override
    public void destroy() {
    }
