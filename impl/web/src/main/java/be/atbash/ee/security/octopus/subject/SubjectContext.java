 ...
 */
@ShiroEquivalent(shiroClassNames = {"org.apache.shiro.subject.SubjectContext"})
public interface SubjectContext extends Map<String, Object> {
     ...
     * instance
     */
    WebSecurityManager resolveSecurityManager();
     ...
     *                being created.
     */
    void setSubject(WebSubject subject);
    ...
    HttpServletResponse resolveServletResponse();
