...
public class CallMP {
    ...
    public static void main(String[] args) throws MalformedURLException {
        //FIXME Example currently isn't working when ErrorInfo is returned (JSON not handled by Apache CXF)

        // tokenEncoded should be taken from <user_home>/octopus.offline.token and generated by CreateOfflineTokenFile
        String tokenEncoded = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsIk9jdG9wdXMgT2ZmbGluZSI6InYwLjIiLCJraWQiOiJsb2NhbCBzZWNyZXQifQ.eyJzdWJqZWN0IjoicmRlYnVzc2NoZXIiLCJwZXJtaXNzaW9ucyI6WyJkZW1vOm9mZmxpbmU6KiJdLCJuYW1lIjoiUnVkeSBEZSBCdXNzY2hlciIsImlkIjoiUnVkeSJ9.NF8f_hHp6BgnJkUDEXN83q84Ap-rgph6zOOvYP-WVvA";
