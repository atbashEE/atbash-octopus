...
// @RegisterProvider(MPRestClientProvider.class) automatically by octopus.rest.client.providers config

// FIXME  add UnauthorizedExceptionMapper dynamically (through RestClientBuilderListener)
