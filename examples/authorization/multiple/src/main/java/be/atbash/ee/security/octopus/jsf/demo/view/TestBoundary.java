...
public class TestBoundary {
    ...
    public void executeWithPermission() {
        System.out.println("executeWithPermission demo:read");
    }

    @RequiresPermissions("special:action:*")
    public void executeWithSpecialPermission() {
        System.out.println("executeWithPermission special:action");
    }
}
