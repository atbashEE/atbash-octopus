 ...
 */
package be.atbash.ee.security.octopus.jsf.boundary;
...
public class TestBoundary {
    ...
    @DemoPermissionCheck(DemoPermission.ADVANCED_PERMISSION)
    public String doAdvancedAction() {
        return "Advanced Action Method called";
    }
}
